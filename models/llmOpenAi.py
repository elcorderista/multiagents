...
if not Config.API_BASE or not Config.OPENAI_API_DEPLOPYMENT_NAME or not Config.OPENAI_API_KEY:
    raise ValueError("API_BASE, OPENAI_API_DEPLOPYMENT_NAME, OPENAI_API_KEY must be set in Config")
